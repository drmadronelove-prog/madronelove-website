          ...
          <div className="mx-auto w-full max-w-6xl px-6 lg:px-8 pt-32 pb-[0.8rem]">
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-4 items-center">
              ...
              <div className="lg:col-span-5 lg:pr-8">
                <h1 className="font-[family-name:var(--font-classic)] text-[2.75rem] md:text-[3.5rem] lg:text-[4rem] font-light text-[var(--ink)] leading-[1.1] tracking-tight">
              ...
              <div className="lg:col-span-7 lg:pl-8">
                <div className="relative max-w-md mx-auto lg:max-w-none lg:mx-0 lg:mt-16 lg:scale-[0.69] lg:origin-top border-[7.5px] border-[var(--gold)] p-2 bg-white shadow-xl lg:-mb-32">
